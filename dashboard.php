...
// Auto-create expenses table if it doesn't exist yet
...
<main class="app-main">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
        ...
        <div class="d-flex gap-2 flex-wrap">
            <a href="sales.php" class="btn-pink">
    ...
    <div class="card mb-4 p-3" style="border-color:rgba(232,23,93,0.2);">
        <div class="d-flex flex-wrap gap-4 align-items-center">
            <div>
                ...
                <div style="font-family:'Syne',sans-serif;font-size:1.1rem;font-weight:700;color:#e8175d;">₱<?= number_format($monthRevenue, 2) ?></div>
            </div>
            ...
            <div>
                ...
                <div style="font-family:'Syne',sans-serif;font-size:1.1rem;font-weight:700;color:#fca5a5;">₱<?= number_format($monthExp, 2) ?></div>
            </div>
            <div style="color:#7a8499;font-size:1.2rem;">=</div>
            <div>
                <div style="font-size:.68rem;font-weight:700;text-transform:uppercase;letter-spacing:.5px;color:#7a8499;">Net Profit</div>
                <div style="font-family:'Syne',sans-serif;font-size:1.3rem;font-weight:700;" class="<?= $monthProfit >= 0 ? 'text-profit' : 'text-loss' ?>">
                    ...
                    <div class="p-3">
                        ...
                        ">
                            ...
                            <div style="text-align:right;">
                                ...
                                <div style="font-size:.65rem;color:#7a8499;margin-top:2px;">Min: <?= $item['reorder_threshold'] ?></div>
                            </div>
                        </div>
                        <?php endforeach; ?>
                        <a href="inventory.php#reorder-panel" class="btn-pink" style="width:100%;justify-content:center;margin-top:4px;font-size:.82rem;">
                            Restock Now
                        </a>
                    </div>
                </div>
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: ['#e8175d','#ff3d80','#b0134a','#06b6d4','#3b82f6'],
                borderRadius: 7,
                borderSkipped: false,
            }],
        },
