    ...
    <main class="app-main">
            ...
            <div class="col-6 col-lg-3">
                <div class="kpi-card">
                    ...
                    <div>
                        ...
                        <div class="kpi-sub"><a href="expenses.php" style="color:#7a8499;font-size:.72rem;">manage →</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card mb-4 p-3" style="border-color:rgba(232,23,93,0.2);">
            <div class="d-flex flex-wrap gap-4 align-items-center">
                <div>
                    <div
                        style="font-size:.68rem;font-weight:700;text-transform:uppercase;letter-spacing:.5px;color:#7a8499;">
                        Monthly Revenue</div>
                    <div style="font-family:'Syne',sans-serif;font-size:1.1rem;font-weight:700;color:#e8175d;">
                        ₱<?= number_format($monthRevenue, 2) ?></div>
                </div>
        ...
        <div class="row g-3 mb-4">
            <div class="col-lg-8">
                <div class="chart-card">
                    <h6><i class="bi bi-graph-up me-2" style="color:#e8175d;"></i>Revenue vs Expenses — Last 30 Days
                    </h6>
                        ...
                        <div class="card-body p-0">
                            ...
                            ">
                                        ...
                                        <div style="text-align:right;">
                                            ...
                                            <div style="font-size:.65rem;color:#7a8499;margin-top:2px;">Min:
                                                <?= $item['reorder_threshold'] ?>
                                            </div>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
                                <a href="inventory.php#reorder-panel" class="btn-pink"
            ...
            new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        backgroundColor: ['#1a1919', '#0f0e0f', '#141414', '#d7d8d8', '#e2e2e2'],
                        borderRadius: 7,
                        borderSkipped: false,
                    }],
                },
