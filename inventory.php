...
<head>
    ...
    <title>Inventory — Dispeedway</title>
    ...
    <style>
        ...
        .inv-toolbar .form-control::placeholder { color: #7a8499; }
        .inv-toolbar .form-select option { background: #1c2030; }
        ...
        .inv-tabs .nav-link:hover { color: #e8ecf4; }
        ...
        .row-low  { background: rgba(245,158,11,.07) !important; }
        .row-zero { background: rgba(239,68,68,.07) !important; }
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-input form-select" id="addUnit" required>
                            ...
                            <option>Gallon</option><option>Liter</option>
                            <option>Piece</option><option>Box</option><option>Set</option>
                        </select>
                    </div>
                    <div class="col-md-4">
