        ...
        <div id="reportOut" style="display:none;">
            <div class="ledger-card">
                ...
                <div class="monthly-totals" id="monthlyTotals" style="display:none;">
                    <div class="tot-row">
                        <span class="t-lbl"><i class="bi bi-box-seam" style="color:#93c5fd;"></i>Total Revenue from
                            Products / Goods</span>
                        <span class="t-val cv-parts" id="mParts">₱0.00</span>
                    </div>
                    <div class="tot-row">
                        <span class="t-lbl"><i class="bi bi-wrench-adjustable" style="color:#34d399;"></i>Total Revenue
                            from Labor</span>
                    ...
                    <div class="tot-grand">
                        <span class="t-lbl"><i class="bi bi-graph-up-arrow"
                                style="color:#e8175d;font-size:1.1rem;"></i>Total Monthly Revenue</span>
