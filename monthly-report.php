...
<head>
    ...
    <style>
        ...
        .rpt-select option { background: #161b27; }
        ...
        .ledger-tbl tbody td:first-child { text-align: left; }
        .ledger-tbl tbody td:last-child  { border-right: none; }
        .ledger-tbl tbody tr:hover td { background: rgba(74,222,128,.02); }
        ...
        .monthly-totals { border-top: 1px solid rgba(74,222,128,.12); padding: 18px 22px; }
        .tot-row {
        ...
        .tot-row .t-lbl { display: flex; align-items: center; gap: 9px; color: #64748b; font-weight: 600; }
        .tot-row .t-val { font-family: 'Space Grotesk', sans-serif; font-weight: 700; font-size: .93rem; }
        .tot-grand {
            display: flex; align-items: center; justify-content: space-between;
        ...
        .tot-grand .t-lbl { color: #e2e8f0; font-size: .92rem; font-weight: 700; display:flex; align-items:center; gap:9px; }
        .tot-grand .t-val { font-family: 'Space Grotesk', sans-serif; font-weight: 800; font-size: 1.2rem; }
        ...
        .exp-desc-list { text-align: left; font-size: .71rem; color: #f87171; line-height: 1.5; }
        .exp-desc-list div { white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 190px; }

        .d-num  { font-weight: 700; color: #e2e8f0; }
        .d-name { font-size: .68rem; color: #4b5a6e; }

        .state-box { text-align: center; padding: 70px 20px; color: #4b5a6e; }
        ...
        .chart-title {
            font-family: 'Space Grotesk', sans-serif;
            font-size: .88rem; font-weight: 600; color: #e2e8f0; margin-bottom: 4px;
        }
        .chart-sub { font-size: .72rem; color: #4b5a6e; margin-bottom: 14px; }
    ...
    <div id="reportOut" style="display:none;">
        ...
        <div class="row g-3 mb-4" id="chartsRow">
            ...
            <div class="col-lg-8">
                <div class="chart-wrap">
                    <div class="chart-title"><i class="bi bi-bar-chart me-2" style="color:#4ade80;"></i>Weekly Revenue Breakdown</div>
                    ...
                    <div style="position:relative;height:220px;">
                        <canvas id="weeklyChart" role="img" aria-label="Weekly revenue breakdown bar chart">Weekly parts, labor, and expenses.</canvas>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="chart-wrap">
                    ...
                    <div style="position:relative;height:180px;">
                        <canvas id="splitDonut" role="img" aria-label="Donut chart of parts vs labor revenue">Parts vs Labor split.</canvas>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="chart-wrap">
                    <div class="chart-title"><i class="bi bi-graph-up me-2" style="color:#a78bfa;"></i>Daily Net Profit</div>
                    ...
                    <div style="position:relative;height:180px;">
                        <canvas id="dailyLineChart" role="img" aria-label="Daily net profit line chart">Daily profit over the month.</canvas>
                    </div>
                </div>
            </div>
        ...
        <div class="ledger-card">
            ...
            <div class="monthly-totals" id="monthlyTotals" style="display:none;">
                <div class="tot-row">
                    <span class="t-lbl"><i class="bi bi-box-seam" style="color:#60a5fa;"></i>Total Revenue from Products / Goods</span>
                    <span class="t-val cv-parts" id="mParts">₱0.00</span>
                </div>
                <div class="tot-row">
                    <span class="t-lbl"><i class="bi bi-wrench-adjustable" style="color:#4ade80;"></i>Total Revenue from Labor</span>
                ...
                <div class="tot-grand">
                    <span class="t-lbl"><i class="bi bi-graph-up-arrow" style="color:#4ade80;font-size:1.1rem;"></i>Net Monthly Revenue</span>
