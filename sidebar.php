...
<style>
    ...
    .sb-search:focus-within .sb-search-icon {
...
<div class="sb-topbar" id="sbTopbar">
    <button class="sb-topbar-toggle" id="sbToggle" aria-label="Open navigation menu" aria-expanded="false"
...
<aside class="sidebar" id="sidebar" role="navigation" aria-label="Main navigation">
    ...
    <a href="dashboard.php" class="sb-logo">
        <div class="sb-logo-mark">
            <img src="assets/img/logo.jpg" alt="Dspeedway Logo" class="sb-brand-logo" loading="lazy" width="34"
                height="34">
        </div>
    ...
    <div class="sb-search">
        ...
        <input type="search" id="sbSearch" class="sb-search-input" placeholder="Search menu…" autocomplete="off"
            spellcheck="false" aria-label="Search navigation items" maxlength="50">
    ...
    <a href="sales.php" class="sb-link <?= $activePage === 'sales' ? 'active' : '' ?>"
        data-sb-label="daily transaction sales new">
    ...
    <a href="sales-history.php" class="sb-link <?= $activePage === 'sales_history' ? 'active' : '' ?>"
        data-sb-label="sales history records">
    ...
    <a href="monthly-report.php" class="sb-link <?= $activePage === 'monthly_report' ? 'active' : '' ?>"
        data-sb-label="monthly report analytics">
    ...
    <a href="inventory.php" class="sb-link <?= $activePage === 'inventory' ? 'active' : '' ?>"
        data-sb-label="inventory products stock items">
    ...
    <a href="profile.php" class="sb-link <?= $activePage === 'profile' ? 'active' : '' ?>"
        data-sb-label="profile account users settings">
