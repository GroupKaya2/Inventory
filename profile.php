...
<head>
    ...
    .ac-left-sub {
        font-size:.75rem;color:#4b5a6e;
        padding:0 20px 18px;line-height:1.5;
    }
    .ac-nav-section {
        font-size:.58rem;font-weight:700;text-transform:uppercase;letter-spacing:.8px;
        color:#1e2a3a;padding:14px 20px 5px;
    }
    .ac-nav-item {
        display:flex;align-items:center;gap:11px;
        padding:10px 12px;margin:1px 8px;width:calc(100% - 16px);
        cursor:pointer;border:none;background:none;text-align:left;
        color:#64748b;font-size:.83rem;font-weight:500;
        font-family:'Inter',sans-serif;border-radius:9px;
        transition:background .12s,color .12s;
    }
    .ac-nav-item:hover { background:rgba(255,255,255,.05);color:#e2e8f0; }
    .ac-nav-item.active { background:rgba(74,222,128,.08);color:#fff; }
    .nav-icon {
        width:32px;height:32px;border-radius:50%;
        background:rgba(255,255,255,.05);
        display:flex;align-items:center;justify-content:center;
        font-size:.82rem;flex-shrink:0;color:#4b5a6e;transition:all .12s;
    }
    .ac-nav-item:hover .nav-icon, .ac-nav-item.active .nav-icon {
        background:rgba(74,222,128,.12);color:#4ade80;
    }

    /* RIGHT */
    .ac-right { flex:1;padding:28px 30px;overflow-y:auto; }
    ...
    .ac-right-sub { font-size:.78rem;color:#4b5a6e;margin-bottom:22px;line-height:1.5; }
    .ac-section-label {
        font-family:'Space Grotesk',sans-serif;
    ...
    /* Cards */
    .ac-card {
        background:#1c2336;border:1px solid rgba(255,255,255,.07);
    ...
    .ac-row-avatar {
        ...
        font-size:.88rem;color:#4ade80;flex-shrink:0;
    }
    .ac-row-name  { font-size:.88rem;font-weight:600;color:#e2e8f0; }
    .ac-row-sub   { font-size:.75rem;color:#4b5a6e;margin-top:1px; }
    .ac-chevron   { color:#4b5a6e;font-size:.8rem;margin-left:auto;flex-shrink:0; }
    ...
    .ac-detail-row:hover { background:rgba(255,255,255,.03); }
    .ac-detail-label { font-size:.85rem;font-weight:600;color:#e2e8f0; }
    .ac-detail-val   { font-size:.77rem;color:#4b5a6e;margin-top:2px; }
    ...
    .ac-add-link:hover { background:rgba(74,222,128,.04); }

    /* Manager cards */
    .mgr-card {
        background:#1c2336;border:1px solid rgba(255,255,255,.07);
        border-radius:10px;display:flex;align-items:center;
        gap:13px;padding:14px 16px;margin-bottom:8px;transition:border-color .15s;
    }
    .mgr-card:hover { border-color:rgba(74,222,128,.18); }
    .mgr-avatar {
    ...
    .mgr-name  { font-size:.87rem;font-weight:600;color:#e2e8f0; }
    .mgr-email { font-size:.74rem;color:#4b5a6e; }
    .mgr-actions { margin-left:auto;display:flex;gap:6px;flex-shrink:0; }

    .btn-edit-u {
        background:rgba(96,165,250,.08);border:1px solid rgba(96,165,250,.2);
        color:#93c5fd;padding:5px 12px;border-radius:7px;
        font-size:.76rem;cursor:pointer;transition:background .15s;
        font-family:'Inter',sans-serif;
    }
    .btn-edit-u:hover { background:rgba(96,165,250,.18);color:#fff; }
    .btn-del-u {
        background:rgba(248,113,113,.08);border:1px solid rgba(248,113,113,.2);
        color:#fca5a5;padding:5px 12px;border-radius:7px;
        font-size:.76rem;cursor:pointer;transition:background .15s;
        font-family:'Inter',sans-serif;
    }
    .btn-del-u:hover { background:rgba(248,113,113,.18);color:#fff; }

    /* Form */
    .ac-input {
        background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.09);
        border-radius:8px;color:#e2e8f0;padding:9px 13px;
        font-size:.84rem;font-family:'Inter',sans-serif;width:100%;
        transition:border-color .15s;
    }
    .ac-input:focus {
        outline:none;border-color:rgba(74,222,128,.35);
        background:rgba(74,222,128,.03);box-shadow:0 0 0 3px rgba(74,222,128,.06);
    }
    .ac-input::placeholder { color:#2e3a4e; }
    .ac-label {
        font-size:.65rem;font-weight:600;text-transform:uppercase;letter-spacing:.6px;
        color:#4b5a6e;display:block;margin-bottom:5px;
    }
    .ac-input[readonly] { opacity:.4;cursor:not-allowed; }

    .info-notice {
        background:rgba(74,222,128,.04);border:1px solid rgba(74,222,128,.12);
        border-radius:9px;padding:12px 16px;font-size:.78rem;color:#4b5a6e;
        line-height:1.6;margin-top:14px;
    }
    .info-notice a { color:#4ade80;font-weight:600; }

    .danger-box {
        background:rgba(248,113,113,.04);border:1px solid rgba(248,113,113,.16);
        border-radius:10px;padding:20px;
    }

    /* Modal */
    .dark-modal .modal-content {
        background:#161b27;border:1px solid rgba(255,255,255,.09);color:#e2e8f0;
    }
    .dark-modal .modal-header {
        background:#111827;border-bottom:1px solid rgba(255,255,255,.07);
    }
    .dark-modal .modal-footer { border-top:1px solid rgba(255,255,255,.07); }

    @media(max-width:768px){
        .ac-wrap { flex-direction:column; }
        .ac-left  { width:100%;border-right:none;border-bottom:1px solid rgba(255,255,255,.07);padding-bottom:10px; }
        .ac-right { padding:20px 16px; }
    }
    </style>
</head>
<body>
    ...
    <div class="ac-wrap">
        ...
        <div class="ac-left">
            ...
            <button class="ac-nav-item" onclick="showPanel('danger',this)">
                <span class="nav-icon" style="background:rgba(248,113,113,.1);color:#f87171;"><i class="bi bi-exclamation-triangle-fill"></i></span>
        ...
        <div class="ac-right">
            ...
            <div class="ac-panel active" id="panel-profiles">
                ...
                <div class="ac-right-sub">Review the profiles and personal details you've added to this Accounts Center.</div>

                <div class="ac-section-label">Profiles</div>
                <div class="ac-card mb-4">
                    <button class="ac-row" style="border-bottom:1px solid rgba(255,255,255,.05);" onclick="showPanel('personal',document.querySelector('[onclick*=personal]'))">
                    ...
                    <button class="ac-add-link" onclick="showPanel('personal',document.querySelector('[onclick*=personal]'))">
                ...
                <div class="ac-card mb-4">
                    ...
                    <button class="ac-row" style="border-bottom:1px solid rgba(255,255,255,.05);"
                        ...
                        <div class="ac-row-avatar" style="background:linear-gradient(135deg,#4338ca,#1e1b4b);color:#a5b4fc;border-color:rgba(165,180,252,.25);"><?= $uIni ?></div>
                        <div style="flex:1;text-align:left;">
                    ...
                    <?php endforeach; ?>
                    <button class="ac-add-link" onclick="showPanel('users',document.querySelector('[onclick*=users]'))">
                ...
                <div class="ac-card">
                    <div class="ac-detail-row" onclick="showPanel('personal',document.querySelector('[onclick*=personal]'))">
                        <div style="flex:1;">
                    ...
                    <div class="ac-detail-row" onclick="showPanel('password',document.querySelector('[onclick*=password]'))">
                        <div style="flex:1;">
                    ...
                    <div class="ac-detail-row">
                        <div style="flex:1;">
                            ...
                            <div class="ac-detail-val"><?= $isOwner ? 'Owner — full system access' : 'Manager — limited access' ?></div>
                        </div>
                        <i class="bi bi-chevron-right ac-chevron"></i>
                    </div>
                ...
                <div class="info-notice">
                    ...
                    <?php if ($isOwner): ?>
                    <a href="#" onclick="showPanel('users',document.querySelector('[onclick*=users]'));return false;">Learn more about managing accounts →</a>
                    <?php endif; ?>
                </div>
            </div>
                ...
                <div class="ac-card">
                    <div style="padding:20px 22px;">
                        <div class="mb-3">
                            ...
                            <input type="text" class="ac-input" id="updName" value="<?= htmlspecialchars($me['name']) ?>">
                        </div>
                        <div class="mb-3">
                            <label class="ac-label">Email Address</label>
                            <input type="email" class="ac-input" id="updEmail" value="<?= htmlspecialchars($myEmail) ?>">
                        </div>
                        <div class="mb-4">
                            <label class="ac-label">Role</label>
                            <input type="text" class="ac-input" value="<?= $isOwner ? 'Owner' : 'Manager' ?>" readonly>
                        </div>
            ...
            <div class="ac-panel" id="panel-password">
                ...
                <div class="ac-card">
                    <div style="padding:20px 22px;">
                        <div style="background:rgba(251,191,36,.05);border:1px solid rgba(251,191,36,.16);border-radius:8px;padding:11px 15px;margin-bottom:20px;font-size:.79rem;color:#fde68a;">
                            <i class="bi bi-shield-check me-2"></i>Passwords are encrypted with bcrypt and never stored in plain text.
                        </div>
                        <div class="mb-3">
                            <label class="ac-label">Current Password</label>
                            <input type="password" class="ac-input" id="curPass" placeholder="Enter current password">
                        </div>
                        <div class="mb-3">
                            <label class="ac-label">New Password</label>
                            <input type="password" class="ac-input" id="newPass" placeholder="At least 6 characters">
                        </div>
                        <div class="mb-4">
            ...
            <div class="ac-panel" id="panel-users">
                ...
                <div class="mgr-card" id="usercard-<?= $u['id'] ?>">
                    <div class="mgr-avatar" style="background:<?= $grad ?>;color:<?= $tc ?>;border:1px solid <?= $bc ?>;">
                        <?= $uIni ?>
                    </div>
                    <div style="flex:1;min-width:0;">
                        <div class="mgr-name">
                            <?= htmlspecialchars($u['name']) ?>
                            <?php if ($isMe): ?><span style="background:rgba(74,222,128,.1);color:#4ade80;font-size:.6rem;font-weight:700;padding:1px 7px;border-radius:4px;margin-left:6px;">You</span><?php endif; ?>
                        </div>
                        <div class="mgr-email"><?= htmlspecialchars($u['email']) ?></div>
                        <?php if (!empty($u['created_at'])): ?>
                        <div style="font-size:.67rem;color:#2e3a4e;margin-top:1px;">Joined <?= date('M d, Y', strtotime($u['created_at'])) ?></div>
                        <?php endif; ?>
                    </div>
                    <span style="background:<?= $u['role']==='owner'?'rgba(74,222,128,.1)':'rgba(100,116,139,.1)' ?>;color:<?= $u['role']==='owner'?'#4ade80':'#94a3b8' ?>;padding:3px 10px;border-radius:5px;font-size:.69rem;font-weight:600;white-space:nowrap;">
                        <?= $u['role']==='owner' ? '⬡ Owner' : '◈ Manager' ?>
                    </span>
                    <div class="mgr-actions">
                        <?php if ($u['role']!=='owner' || $isMe): ?>
                        <button class="btn-edit-u" onclick="openEditUser(<?= $u['id'] ?>,'<?= addslashes(htmlspecialchars($u['name'])) ?>','<?= addslashes(htmlspecialchars($u['email'])) ?>')">
                            <i class="bi bi-pencil me-1"></i>Edit
                        </button>
                        <?php endif; ?>
                        <?php if (!$isMe && $u['role']!=='owner'): ?>
                        <button class="btn-del-u" onclick="removeUser(<?= $u['id'] ?>,'<?= addslashes(htmlspecialchars($u['name'])) ?>')">
            ...
            <div class="ac-panel" id="panel-danger">
                ...
                <div class="danger-box">
                    ...
                    <div style="font-size:.8rem;color:#64748b;margin-bottom:14px;line-height:1.6;">
                        Permanently deletes all sales records, line items, and inventory transactions. This cannot be undone.
                    </div>
    ...
    <div class="modal-dialog dark-modal">
        <div class="modal-content dark-modal">
            <div class="modal-header dark-modal">
                <h5 class="modal-title" style="color:#fff;font-size:.93rem;"><i class="bi bi-pencil-square me-2" style="color:#4ade80;"></i>Edit Account</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body" style="padding:20px;">
                <input type="hidden" id="editUserId">
                <div style="background:rgba(96,165,250,.06);border:1px solid rgba(96,165,250,.16);border-radius:8px;padding:10px 14px;margin-bottom:16px;font-size:.77rem;color:#93c5fd;">
                    <i class="bi bi-info-circle me-2"></i>Leave a field blank to keep it unchanged.
                </div>
                <div class="mb-3"><label class="ac-label">Full Name</label><input type="text" class="ac-input" id="editUserName" placeholder="Leave blank to keep current"></div>
                <div class="mb-3"><label class="ac-label">Email Address</label><input type="email" class="ac-input" id="editUserEmail" placeholder="Leave blank to keep current"></div>
                <div class="mb-3"><label class="ac-label">New Password</label><input type="password" class="ac-input" id="editUserPass" placeholder="Leave blank to keep current"></div>
                <div><label class="ac-label">Confirm Password</label><input type="password" class="ac-input" id="editUserPassConf" placeholder="Confirm new password"></div>
            </div>
            <div class="modal-footer dark-modal" style="padding:14px 20px;">
                <button type="button" class="btn-ghost" data-bs-dismiss="modal">Cancel</button>
                <button type="button" class="btn-pink" id="saveEditUserBtn" onclick="submitEditUser()"><i class="bi bi-check-lg me-1"></i>Save Changes</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="addManagerModal" tabindex="-1">
    <div class="modal-dialog dark-modal">
        <div class="modal-content dark-modal">
            <div class="modal-header dark-modal">
                <h5 class="modal-title" style="color:#fff;font-size:.93rem;"><i class="bi bi-person-plus me-2" style="color:#4ade80;"></i>Add Manager</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body" style="padding:20px;">
                <div class="mb-3"><label class="ac-label">Full Name *</label><input type="text" class="ac-input" id="newMgrName" placeholder="Full Name"></div>
                <div class="mb-3"><label class="ac-label">Email *</label><input type="email" class="ac-input" id="newMgrEmail" placeholder="email@example.com"></div>
                <div class="mb-3"><label class="ac-label">Password * <span style="color:#2e3a4e;">(min 6 chars)</span></label><input type="password" class="ac-input" id="newMgrPass" placeholder="Password"></div>
                <div><label class="ac-label">Confirm Password *</label><input type="password" class="ac-input" id="newMgrPassConf" placeholder="Confirm"></div>
            </div>
            <div class="modal-footer dark-modal" style="padding:14px 20px;">
                <button type="button" class="btn-ghost" data-bs-dismiss="modal">Cancel</button>
                <button type="button" class="btn-pink" id="saveNewMgrBtn" onclick="submitAddManager()"><i class="bi bi-person-check me-1"></i>Create Manager</button>
            </div>
        </div>
    </div>
</div>
