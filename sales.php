        ...
        <?php else: ?>
                ...
                <div class="row g-3 align-items-end">
                    <div class="col-md-3">
                        <label class="form-label"
                            style="color:#7a8499;font-size:.72rem;font-weight:700;text-transform:uppercase;letter-spacing:.5px;">
                            Transaction Date
                        </label>
                        <input type="date" class="dark-input" id="saleDate" value="<?= $today ?>" max="<?= $today ?>"
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="dark-input" id="plateNumber" placeholder="e.g. ABC-123"
            ...
            <div class="sale-card mb-3">
                ...
                <?php if (!empty($savedExpenses)): ?>
                    <div
                        style="margin-top:12px;padding:12px 14px;background:rgba(239,68,68,.05);border:1px solid rgba(239,68,68,.12);border-radius:10px;">
                        <div
                            style="font-size:.67rem;font-weight:700;text-transform:uppercase;letter-spacing:.5px;color:#7a8499;margin-bottom:8px;">
                        ...
                        <?php endforeach; ?>
                        <div
                            style="border-top:1px solid rgba(239,68,68,.15);margin-top:6px;padding-top:6px;font-size:.8rem;color:#fca5a5;font-weight:700;text-align:right;">
        ...
        async function submitSale() {
            ...
            for (let i = 0; i < exps.length; i++) {
                ...
                if (e.amount > 0 && e.description.trim().length < 3) {
                    Swal.fire({
                        icon: 'warning', title: 'Expense description required',
                        text: `Expense row ${i + 1}: please specify what the money was used for (min 3 chars).`
                    }); return;
                }
            }
